...
def setup_behavior_tree():
    ...
    early_occupy.child_nodes = [owned_planets, occupy]
    ...
    play_offensively.child_nodes = [early_occupy, offensive_plan, spread_sequence]
    play_defensively.child_nodes = [early_occupy, defensive_plan, spread_sequence]

    root.child_nodes = [play_offensively, play_defensively]
